...
},{"process":8}],32:[function(require,module,exports) {
var global = (1,eval)("this");
/*!
 *  howler.js v2.0.9
 *  howlerjs.com
...
module.exports="/fucking-pathetic.dd86db05.mp3";
},{}],41:[function(require,module,exports) {
module.exports="/background.29af52e9.mp3";
},{}],42:[function(require,module,exports) {
module.exports="/background.1c4010b9.webm";
...
},{"./assets/background.png":[["background.9e87f27a.png",28],28],"./assets/gordon.png":[["gordon.6316ace9.png",18],18],"./assets/gordon_talk.gif":[["gordon_talk.9ecd87e1.gif",37],37],"./assets/gordon_angry_talk.gif":[["gordon_angry_talk.0570b8f2.gif",34],34],"./assets/gordon_realmad_talk.gif":[["gordon_realmad_talk.6330de41.gif",35],35],"./assets/steak.png":[["steak.e4d895fb.png",15],15],"_css_loader":5}],2:[function(require,module,exports) {
'use strict';
...
var _fuckingPathetic = require('./assets/fucking-pathetic.mp3');

var _fuckingPathetic2 = _interopRequireDefault(_fuckingPathetic);

var _background = require('./assets/background.mp3');

var _background2 = _interopRequireDefault(_background);

var _background3 = require('./assets/background.webm');
...
var backgroundSound = new Howl({
  src: [_background4.default, _background2.default],
  autoplay: true,
  volume: .1,
  loop: true
});
...
// background music
var sound = new Howl({
  src: [_fuckingPathetic2.default],
  volume: 2
});

(0, _interactjs2.default)('.item').draggable({
...
var gordonAngryLevel = 0;
var gordonAngry = function gordonAngry(type) {
  gordonAngryLevel++;
  (0, _jquery2.default)('#gordon').removeClass().addClass('mad' + gordonAngryLevel);
  sound.play();
  setTimeout(function () {
    (0, _jquery2.default)('#gordon').removeClass();
  }, sound.duration() * 1000);
};
setInterval(function () {
  grilling.forEach(function (el) {
    var original = parseInt(el.getAttribute('data-grilled')) || 0;
    el.setAttribute('data-grilled', original + 1);
    var contrast = (30 - original) / 30 * 2;
    (0, _jquery2.default)(el).css('filter', 'contrast(' + contrast + ')');
    if (original === 30) return gordonAngry('meat');
    if (original === 20) return gordonAngry('meat');
    if (original === 10) return gordonAngry('meat');
  });
}, 500);
...
},{"interactjs":6,"jquery":4,"howler":32,"./assets/fucking-pathetic.mp3":39,"./assets/background.mp3":41,"./assets/background.webm":42,"./style.scss":3}],43:[function(require,module,exports) {
...
//# sourceMappingURL=/game.cf8e35c9.map